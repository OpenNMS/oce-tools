...
public class OceGeneratorTest {
    ...
    public void canGenerateModelAlarmsAndSituationsForTicket() {
        ...
        assertThat(alarmsAssociatedTo, containsInAnyOrder(ResourceKey.key("PORT", "dc1-sw01: GigabitEthernet2/0/27"),
                ResourceKey.key("EIGRP_NEIGHBOR", "dc1-sw01: GigabitEthernet2/0/27: 10.1.1.85"),
                ResourceKey.key("LINK", "dc1-sw01: GigabitEthernet2/0/27<->dc2-sw01: GigabitEthernet2/0/27"),
                ResourceKey.key("PORT", "dc2-sw01: GigabitEthernet2/0/27"),
                ResourceKey.key("EIGRP_NEIGHBOR", "dc2-sw01: GigabitEthernet2/0/27: 10.1.1.86")));
    }

...
package org.opennms.oce.tools.onms.model.api;
...
public interface AlarmDefinition extends EventMatcher {
    ...
    String getExpectedManagedObjectInstance();

    boolean hasClearingEvent();

    EventDefinition getEventDefinitionForTrigger();

    EventDefinition getEventDefinitionForClear();

    List<EventDefinition> getEventDefinitions();

    List<TriggerClearPair> getTriggerClearPairs();

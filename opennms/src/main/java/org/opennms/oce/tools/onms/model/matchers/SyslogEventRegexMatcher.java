...
public class SyslogEventRegexMatcher implements EventMatcher {

    private final Pattern pattern;

    public SyslogEventRegexMatcher(String regex) {
        this.pattern = Pattern.compile(regex);
    }

    public SyslogEventRegexMatcher(Pattern pattern) {
    ...
    public boolean matches(SyslogEvent syslogEvent) {
        return pattern.matcher(syslogEvent.getMessage()).matches();
    }

    @Override
    public void visit(EventMatcherVisitor visitor) {
        visitor.visitSyslogEventRegexMatcher(this);
    }

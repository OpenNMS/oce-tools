...
public abstract class AbstractTrapEventDefinition implements EventDefinition {

    private final SnmpTrapEventMatcher matcher;

    public AbstractTrapEventDefinition(OID enterprise, Integer generic, Integer specific) {
        matcher = new SnmpTrapEventMatcher(enterprise, generic, specific);
    }
